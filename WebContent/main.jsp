...
<<<<<<< HEAD
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href='#'><span class="glyphicon glyphicon-user"></span>Ï†ïÎ≥¥ÏàòÏ†ï </a></li>
      <li><a href="logout.jsp"><span class="glyphicon glyphicon-log-in"></span> Sign out</a></li>
    </ul>
  </div>
</nav>
	<!-- ÏÉÅÎã®Î∞î Î∂ÄÎ∂Ñ ÎÅù -->
=======
   <center>
   <h1>≥ÛªÍπ∞ ±∏∞Ê«œ±‚</h1>
   </center>
		...
		try
                    {
                       ...
                       while(rs.next()){
		        		...
		        		<p>
		        		<table>
		        		<tr><td width="80">π´∞‘</td><td><%=weight %>kg</td></tr>
						<tr><td width="80">∞°∞›</td><td><%=price %>ø¯</td></tr>
						<tr><td width="80">∞‘Ω√¿⁄</td><td><%=farmer_id %></td></tr>
						<tr><td width="80">º≥∏Ì</td><td><%=contents %></td></tr>
						</table>
						</p></span>
            			</div>
						...
						<tr><td width="80">ªÛ«∞∏Ì</td><td><%=pname %></td></tr>
						<tr><td width="80">π´∞‘</td><td><%=weight %>kg</td></tr>
						<tr><td width="80">∞°∞›</td><td><%=price %>ø¯</td></tr>
						<tr><td width="80">∞‘Ω√¿⁄</td><td><%=farmer_id %></td></tr>
						<tr><td width="80">º≥∏Ì</td><td><%=contents %></td></tr>
...
%>
    ...
    <!-- Menu Toggle Script -->
    <script>
    $("#wrapper").toggleClass("toggled");//ÏÇ¨Ïù¥ÎìúÎ∞î ÏûêÎèôÏúºÎ°ú ÎÇòÏò§Í≤å
